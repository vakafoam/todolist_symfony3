...
class TodoController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($todo)
          ...
          ->add('due_date', DateTimeType::class, array('attr'
            =>array('class'=>'', 'style'=>'margin-bottom:15px;')))
          ->add('save', SubmitType::class, array('label'=>'Create Todo','attr'
    ...
    public function editAction($id, Request $request)
    {
      ...
      $form = $this->createFormBuilder($todo)
        ...
        ->add('due_date', DateTimeType::class, array('attr'
          =>array('class'=>'', 'style'=>'margin-bottom:15px;')))
        ->add('save', SubmitType::class, array('label'=>'Update Todo','attr'
          =>array('class'=>'btn btn-primary', 'style'=>'margin-bottom:15px;')))
        ->getForm();
